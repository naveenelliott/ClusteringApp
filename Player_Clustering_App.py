...
cols_we_want = ['Player Full Name', 'Goal', 'Assist', 'Dribble',
...
def calculate_percentiles(df):
    ...
    saved_series = df['Player Full Name']
    df.drop(columns=['Player Full Name'], inplace=True)
    ...
    percentiles_df['Player Full Name'] = saved_series
